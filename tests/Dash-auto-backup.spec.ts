...
test('test', async ({ page }) => {
  ...
  //Variable print test
  //await page.getByPlaceholder('Company ID').fill(Employee1.FLN_email); 
 ...
 */
  ...
  await page.locator('#ctl00_ContentPlaceHolder1_txtFName').fill(Employee1.first_name);

  //Last Name
  await page.locator('#ctl00_ContentPlaceHolder1_txtFName').press('Tab');
  await page.locator('#ctl00_ContentPlaceHolder1_txtLName').fill(Employee1.last_name);

  //Username
  await page.locator('#ctl00_ContentPlaceHolder1_txtLName').press('Tab');
  await page.locator('#ctl00_ContentPlaceHolder1_txtDASHID').fill(Employee1.username);
  ...
  await page.locator('#ctl00_ContentPlaceHolder1_txtAddress').fill(Employee1.office_location.street);

  //Zipcode
  await page.locator('#ctl00_ContentPlaceHolder1_txtAddress').press('Tab');
  await page.locator('#ctl00_ContentPlaceHolder1_ctl13_ZipCodeTextBox').fill(Employee1.office_location.zipcode);

  //City
  await page.locator('#ctl00_ContentPlaceHolder1_ctl13_ZipCodeTextBox').press('Tab');
  await page.locator('#ctl00_ContentPlaceHolder1_ctl13_CityTextBox').fill(Employee1.office_location.city);

  //State
  await page.locator('#ctl00_ContentPlaceHolder1_ctl13_CityTextBox').press('Tab');
  await page.locator('#ctl00_ContentPlaceHolder1_ctl13_StateComboBox_Input').fill(Employee1.office_location.state);

  //Country
  await page.locator('#ctl00_ContentPlaceHolder1_ctl13_StateComboBox_Input').press('Tab');
  await page.locator('#ctl00_ContentPlaceHolder1_ctl13_CountryComboBox_Input').fill(Employee1.office_location.country);

  //County
  await page.locator('#ctl00_ContentPlaceHolder1_ctl13_CountryComboBox_Input').press('Tab');
  await page.locator('#ctl00_ContentPlaceHolder1_ctl13_RegionCountyComboBox_Input').fill(Employee1.office_location.county);

  //Email
  await page.locator('#ctl00_ContentPlaceHolder1_ctl13_RegionCountyComboBox_Input').press('Tab');
  await page.locator('#ctl00_ContentPlaceHolder1_txtEmail').fill(Employee1.FLN_email);
  ...
  await page.getByAltText('Filter Name column').fill(Employee1.last_name);
